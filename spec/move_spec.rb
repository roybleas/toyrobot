...
RSpec.describe Move do
	context "execute" do
		...
		it "increases x coordinate by 1 when when facing EAST" do
			location = Location.new.setup(direction: :EAST, point: Point.new(0,0))
	...
	context "new location" do
		...
		it "create location with new point" do
			...
			current_location = Location.new.setup(direction: :EAST, point: myPoint )  
